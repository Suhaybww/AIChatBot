      ...
      <div className="max-w-md w-full mx-auto px-6">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Meet <span className="text-red-600">Vega</span>
          </h1>
          
          <p className="text-lg text-gray-700 mb-8 leading-relaxed">
            Your intelligent RMIT companion. Named after the brightest navigation star, Vega guides you through courses, policies, and university life.
          </p>
          
          <div className="p-4 backdrop-blur-sm rounded-xl border border-red-200/30 bg-red-50/20 mb-8">
            <p className="text-red-800 font-semibold text-sm">⭐ Powered by AI</p>
            <p className="text-red-700 text-sm">Your personal guide to academic success</p>
          </div>
        </div>
